  ...
  return (
    <div className="text-right md:hidden">
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className="inline-flex w-full justify-center rounded-md bg-transparent px-4 text-sm font-medium hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
            Menu
            <HiChevronDown
        ...
        >
          <Menu.Items className="absolute right-0 mt-2 w-32 origin-top-right divide-y bg-white text-black dark:bg-black dark:text-white divide-gray-100 rounded-md shadow-lg focus:outline-none">
            <div className="px-1 py-1">
              ...
              <Menu.Item>
                {({ active }) => (
                  <Link href={"https://malikkotb.github.io/blog/"} target="_blank">
                    <button
                      className={`${
                        active ? "bg-black bg-opacity-10 dark:bg-white dark:bg-opacity-10" : ""
                      } group flex w-full items-center rounded-md px-4 py-2 text-sm`}
