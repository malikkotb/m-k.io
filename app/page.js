    ...
    <div className="flex flex-col gap-16 md:gap-24">
      <div className="flex flex-col gap-8">
        ...
        <motion.p
          ...
          className="  max-w-lg"
        >
          Hi, I&apos;m Malik Kotb, a software engineer who loves building cool things with
          code. I am currently focusing on creative frontend development. I studied
          Computer Science: Games Engineering at TUM.
        </motion.p>
        <motion.ul
          variants={animationVariant}
          initial="hidden"
